...
ヒント：
Wキーを押すと、ロボットアームがx軸方向に-1mm(奥)移動します。
Sキーを押すと、ロボットアームがx軸方向に1mm(手前)移動します。
Aキーを押すと、ロボットアームがy軸方向に-1mm(左)移動します。
Dキーを押すと、ロボットアームがy軸方向に1mm(右)移動します。
上矢印キーを押すと、ロボットアームがz軸方向に1mm(上)移動します。
下矢印キーを押すと、ロボットアームがz軸方向に-1mm(下)移動します。
